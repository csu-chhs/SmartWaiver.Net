namespace SmartWaiver.Net.Objects
{
    public class SearchResults
    {
        ...
        /// <summary>
        /// Date waiver will expire (ISO 8601 format)
        /// Note: This value is always empty if your account does not have the days to expiration setting enabled in the waiver console.
        /// </summary>
        ...
        /// <summary>
        /// Date of birth of the first participant on the waiver (ISO 8601 format)
        /// Note: The DOB will be 1800-01-01 if the waiver is set up to use a checkbox for age verification.
        /// </summary>
